...
execute if score @s rc_target matches 0 if score @s rc_cooldown matches ..0 if score @s rc_progress matches 1.. at @s run function dreamy_recalls:teleport/status/cancelled
